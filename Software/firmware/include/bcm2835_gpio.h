//
// Helpful file from git project
//
// Full at: Spider-Droid/Software/third-party/RaspberryPi-GPIO
//
// To retrieve: clone https://github.com/alanbarr/RaspberryPi-GPIO.git
//
